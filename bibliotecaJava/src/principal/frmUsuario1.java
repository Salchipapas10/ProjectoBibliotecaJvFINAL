...
public class frmUsuario1 extends javax.swing.JFrame {
    ...
    private String correo; // El correo del usuario logueado
    ...
    private void cargarLibrosDisponibles() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al cargar libros disponibles: " + e.getMessage());
        }
    }
    ...
    private void cargarLibrosPrestados() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al cargar libros prestados: " + e.getMessage());
        }
    }
        ...
        if (fila == -1) {
            JOptionPane.showMessageDialog(null, "Selecciona un libro para prestar.");
            return;
        }
        DefaultTableModel modelo = (DefaultTableModel) tblLibrosDispo.getModel();
    ...
    // Constructor funcional: úsalo para abrir el panel pasando el correo del usuario logueado
    public frmUsuario1(String correo) {
        this.correo = correo;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmUsuario1("usuario@correo.com").setVisible(true);
            }
        });
